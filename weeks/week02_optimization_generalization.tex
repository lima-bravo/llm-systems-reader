\section{Optimization, Generalization, and Scaling Intuition}
...
from Week~1, indexed over the $N_{\mathrm{tok}}$ (context, token) pairs in
...
\end{equation}
where $i$ indexes (context, token) pairs (Week~1, A1.1b) and the
