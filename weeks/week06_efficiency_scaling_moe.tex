...
from the Chinchilla floor constant $E$ in Week~2). The router maps
...
and its compute-optimal conclusions (Week~2, A2.2) hold with
...
Week~2 Eq.~\eqref{eq:week2-mem-budget},
...
\begin{itemize}
  \item \textbf{ZeRO-1}: shard the optimizer state (the $m_t, v_t$ of
        AdamW from Week~2; the $b_o N$ term of
...
same Lagrangian argument used for Chinchilla in Week~2 applies: at
