...
pre-deployment gate. Chapter~4 (\S\ref{sec:ch4_oov}) discusses
...
of the Chapter~13 diagnostic ladder is the correct place to
...
Chapter~1's treatment of hallucination: the model produces the
...
versioned, evaluated, and maintained separately. Chapter~8
