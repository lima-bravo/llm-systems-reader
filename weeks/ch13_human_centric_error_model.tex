...
well-specified). The remedy is targeted evaluation on
representative examples drawn from the actual deployment
distribution, conducted before the model is relied on in that
context rather than after the first production incident.
