\section{Chapter 12 Refresher: Modern LLM Access --- APIs, SDKs, Agents, and the Model Context Protocol --- Latency, Queues, and Reliability Budgets}

\subsection*{Setting the Scene}
Chapter 12 brings probability back into systems operations. Queueing theory, retry arithmetic, and budget constraints determine whether an otherwise capable model can be deployed reliably. The key insight is compounding: small per-request probabilities become large system effects at scale.
