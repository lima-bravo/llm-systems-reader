...
Chapter~\ref{chap:stat-foundations} of this refresher specialises Steps~2--3 to autoregressive tokens, Steps~8--10 to softmax logits and calibration diagnostics, and binds Step~7 qualitatively to dataset-scale claims. Re-read this preface whenever conditioning or information identities feel like unmotivated algebra.
