\section*{Preface: Probability Building Blocks}
\addcontentsline{toc}{section}{Preface: Probability Building Blocks}

\subsection*{How to read this preface}
...
\subsection*{Step 1 --- Sample space, events, and axioms}
...
\subsection*{Step 2 --- Conditional probability}
...
\subsection*{Step 3 --- Chain rule for probabilities}
...
\subsection*{Step 4 --- Bayes' theorem (compact)}
...
\subsection*{Step 5 --- Random variables and expectation}
...
\subsection*{Step 6 --- Variance and sums (sketch)}
...
\subsection*{Step 7 --- Law of large numbers (operational)}
...
\subsection*{Step 8 --- Maximum likelihood}
...
\subsection*{Step 9 --- Shannon entropy}
...
\subsection*{Step 10 --- Cross-entropy and Kullback--Leibler divergence}
...
\subsection*{Where Chapter 1 picks up}
