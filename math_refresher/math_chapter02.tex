...
\begin{itemize}[leftmargin=1.5em]
  ...
  \emph{Application: Chinchilla compute-optimal allocation (Chapter~6).}
  ...
  A second tool required by Chapter~9 is the \emph{normalising constant} (also called the partition function in the statistical-physics framing that RLHF literature inherits).
  ...
  \emph{Why it matters for DPO (Chapter~9).}
