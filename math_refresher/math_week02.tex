...
Week 2 uses optimization theory as an engineering discipline. The loss from Week 1 tells us \emph{what} to optimize; this week studies \emph{how} optimization behaves under stochastic gradients, finite precision arithmetic, and finite compute budgets.
...
The critical insight along this path is that optimization rules are not interchangeable implementation details. They encode assumptions about noise, curvature, and numerical regime. This chapter's mathematics is the language for checking when those assumptions are plausible.
...
Use the week's reasoning chain:
\begin{enumerate}[leftmargin=1.5em]
...
\subsection*{Pointers}
\begin{itemize}[leftmargin=1.5em]
  \item Loss and KL notation: see Week 1 refresher.
  \item Matrix and norm geometry used by clipping and curvature intuition: see Week 3 refresher.
\end{itemize}
