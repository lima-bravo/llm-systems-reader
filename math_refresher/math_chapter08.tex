...
Chapter 8 studies approximation as a design tool. The evolution from full fine-tuning to parameter-efficient adaptation and quantized deployment was driven by memory/cost constraints. The key insight is to treat each approximation as a hypothesis with measurable error, not a free performance gain.
