...
\textbf{Insight.} Softmax (Chapter~\ref{chap:stat-foundations} tools) turns logits into mixing weights---Preface Step~10 intuition specialised row-wise.
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \textbf{Why this matters for Chapter~\ref{chap:transformer}.} The reader derives all three families. RoPE is the default in Llama, Mistral, and most open-weight models released since 2023; understanding the rotation-matrix identity is the prerequisite for following that derivation.
\end{itemize}
