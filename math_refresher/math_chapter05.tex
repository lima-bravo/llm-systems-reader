...
Chapter 5 is where linear algebra becomes computational architecture. The historical move from recurrence/convolution to attention was motivated by path length and parallelism: make long-range interactions explicit as matrix operations.
