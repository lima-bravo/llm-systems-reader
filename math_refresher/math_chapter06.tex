\section{Chapter 6 Refresher: Pretraining, GPT-Style Models, and In-Context Learning --- Pretraining Objective and Decoding Controls}

\subsection*{Setting the Scene}
Chapter 6 connects statistical learning and generation behavior. Historically, this is where language modeling moved from ``fit data well'' to ``control generation behavior under constraints.'' The critical insight is that decoding is distribution shaping, not retraining.
...
\begin{itemize}[leftmargin=1.5em]
  \item \textbf{Autoregressive NLL objective:} same probability chain as Chapter 1, now at pretraining scale.
