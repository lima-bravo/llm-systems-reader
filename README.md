...
Eleven weekly chapters, each a deep-dive of roughly twenty pages:
...
11. Modern LLM access — APIs, SDKs, agents, IDE integrations, MCP *(planned)*

Each chapter follows a consistent template: learning objectives, conceptual
core, systems-engineering implications, human-factors and failure modes, key
references, recommended university lectures, practitioner lab, and a closing
takeaway.
...
├── weeks/                   One .tex file per chapter
