...
A modern frontier model has hundreds of billions of parameters,
...
The first models too large to fit on a single graphics card
...
further. Mistral AI's \emph{Mixtral 8x7B} in 2024 brought
...
A modern training stack composes several forms of parallelism
...
The dramatic failure modes of distributed training are visible:
...
host these runs are increasingly concentrated in regions with
favourable electricity prices and grid capacity, and several
recent expansions have run into local opposition over water,
land, and grid use. These are not theoretical concerns. They
are showing up in regulatory filings, planning disputes, and
the financial decisions of the companies involved. The
trajectory of the field is increasingly shaped by the
trajectory of its physical infrastructure.
