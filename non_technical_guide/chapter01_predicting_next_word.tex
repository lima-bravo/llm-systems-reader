...
Consider for a moment what it means to predict the next word. You
...
The idea that one symbol in a sequence depends on the symbols
...
The lineage converged on a remarkably simple recipe. Take a
...
A model trained the way we just described is, by construction,
...
\emph{grounding} axis of the error model.
...
as the source of the \emph{meaning} and \emph{grounding} axes
