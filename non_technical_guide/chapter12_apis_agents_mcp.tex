...
The previous eleven chapters described how to build the
...
The first widely available LLM API was OpenAI's GPT-3
...
A modern LLM application is a layered stack. At the bottom are
...
The transition from research demonstration to production
...
This chapter built on Chapter~9 (the aligned model that the
APIs serve), Chapter~10 (the retrieval and tool-use systems
that surround the model), and Chapter~11 (the governance
...
which most production failures occur. Chapter~13 returns to
