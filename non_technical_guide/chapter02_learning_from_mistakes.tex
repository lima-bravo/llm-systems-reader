...
\paragraph{The problem.} Chapter~1 told us \emph{what} we want a language model to do:
...
\paragraph{How we got here.} The mathematics of descending a function by following its slope
